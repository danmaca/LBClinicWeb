    ...
    <footer className="bg-black text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Péče o váš úsměv na prvním místě.
            </p>
            <div className="flex space-x-4">
              <a href={SITE_CONFIG.social.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-accent transition-colors">
          ...
          <div>
            ...
            <address className="not-italic text-gray-400 text-sm space-y-2">
              ...
              <p>{SITE_CONFIG.address.zip} {SITE_CONFIG.address.city}</p>
              <p className="mt-4">
                <a href={`tel:${SITE_CONFIG.phone.replace(/\s+/g, '')}`} className="hover:text-accent transition-colors">{SITE_CONFIG.phone}</a>
              </p>
              <p>
          ...
          <div>
            ...
            <ul className="text-gray-400 text-sm space-y-2">
              <li><a href="#team" className="hover:text-accent transition-colors">{t('nav.team')}</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex justify-between items-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} {SITE_CONFIG.companyName}. Všechna práva vyhrazena.</p>
        </div>
      </div>
    </footer>
  );
