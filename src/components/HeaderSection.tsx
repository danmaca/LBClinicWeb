        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0 flex items-center min-w-0">
            <a
              ...
              className="flex items-center text-[#1d1d1b] hover:text-accent transition-colors duration-[1000ms] focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 rounded-sm"
            >
