...
export const ReferenceCarousel: React.FC = () => {
  ...
  return (
    <div className="mt-5 max-w-full mx-auto w-full overflow-hidden">
      <div className="relative group overflow-hidden rounded-xl shadow-lg bg-gray-900 w-full py-6 px-2 md:px-12 border border-gray-700 min-w-0">
              ...
              >
                <div className="rounded-lg overflow-hidden shadow-sm bg-gray-800 lg:relative h-full min-w-0">
                  ...
                  {slide.personName || slide.text ? (
                    <div className="p-3 sm:p-4 lg:relative lg:z-[2] lg:w-3/5 lg:min-h-[320px] lg:flex lg:flex-col lg:justify-center lg:px-12 lg:py-10 xl:px-16 min-w-0">
                      {slide.personName && (
